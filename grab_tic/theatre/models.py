...
class ScreenDateTime(BaseClass):
...
class OngoingShows(BaseClass):
    ...
    movie = models.ForeignKey('shows.Movies',on_delete=models.CASCADE)

    screen_date_time = models.ManyToManyField('ScreenDateTime')
...
class Bookings(BaseClass):
    ...
    screen_date_time = models.ForeignKey('ScreenDateTime',on_delete=models.CASCADE)
